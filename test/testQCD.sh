...
(time shasum 1 $original) 2> timesha1.txt
...
do
  ...
  #sha1 sorted
  (time shasum 1 new_data.csv) 2> timesha1.txt
  ...
  #sha256 sorted
  (time shasum 256 new_data.csv) 2> timesha256.txt
  ...
  #md5 sorted
  (time md5 new_data.csv) 2> timemd5.txt
